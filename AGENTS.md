...
- **Event reminders**: Sent by the reminder service using reminder templates (`TWILIO_WHATSAPP_EVENT_REMINDER_SINGLE_SESSION_TEMPLATE_SID` [8 vars: 1, 2, 4..9] / `TWILIO_WHATSAPP_EVENT_REMINDER_MULTIPLE_SESSION_TEMPLATE_SID` [9 vars: 1..9]) or event update templates. The cron runs **every 5 minutes** in Asia/Hong_Kong.
