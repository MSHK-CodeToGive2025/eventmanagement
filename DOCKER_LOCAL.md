...
- A **`.env`** file in the project root with at least:
  ...
  - `TWILIO_WHATSAPP_TEMPLATE_SID`, `TWILIO_WHATSAPP_UPDATE_TEMPLATE_SID`
...
- **Template / 21619 or 63016**  
  Ensure `.env` has `TWILIO_WHATSAPP_TEMPLATE_SID` and `TWILIO_WHATSAPP_UPDATE_TEMPLATE_SID` (same values as in Twilio Content Templates).
