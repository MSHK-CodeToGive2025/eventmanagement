...
describe('Events Routes', () => {
  ...
  describe('WhatsApp templates (event update)', () => {
    ...
    it('send-whatsapp-reminder uses event update template with 5 vars: Event, Session, Message, Contact, Phone', async () => {
      const response = await request(app)
    ...
    it('POST :id/send-whatsapp uses event update template with 5 vars for each participant', async () => {
      ...
      expect(vars['4']).toBeDefined();
      expect(vars['5']).toBeDefined();
